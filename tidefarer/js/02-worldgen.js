...
function addBuilding(kind,x,y,label){
  ...
  G.decor.push(b);
  const fp = {house:[2,2],house2:[2,2],igloo:[2,2],forge:[2,2],barn:[3,2],tower:[2,2],castle:[6,3],hut:[2,2],volcano:[6,3],well:[1,1],boat:[0,0],lamp:[0,0],crypt:[0,0],resort:[6,4],windmill:[3,3],waterwheel:[4,3],fruitstand:[1,1],stall:[1,1]}[kind]||[0,0];
