...
const MOBDEF = {
  ...
  stormeye:{hp:900, dmg:24, speed:1.4, aggro:20, xp:900, gold:[0,0], lvl:13, name:'The Hurricane Eye'},      // final sky boss: shielded, hurls dodge-only gale-wisps; only vulnerable when it discharges
