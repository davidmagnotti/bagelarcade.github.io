...
const QUESTS = {
  ...
  mushrooms:{ giver:'orin', title:'Light in the Dark', kind:'gather', need:{mushroom:3},
    ...
    doneText:'Bluecaps, crushed… essence, bound… there. This staff will throw fire that answers to you. Press 3. Mind the eyebrows. <i>He studies you a moment longer than is polite.</i> They tell me the Whisperwood wolves closed on you in the dark and you did not give a single step - most folk would have dropped my mushrooms and run for the tide. I do not put my fire in just any hand, you understand. But a fearless one, curse-broken and washed up out of nowhere… <i>His eyes narrow, not unkindly.</i> Most interesting. And you say you don\'t remember your name? Interesting indeed… <i>He presses the staff into your grip.</i> Take it back down to Elder Maren, and tell her old Orin says you\'re ready for the Hollow King. And here - the ward on my tower is lifted for you now; go inside and lay both hands on the scrying orb, for fire is only half of what a mage owes their feet.',
  ...
  king:{ giver:'maren', title:'The Hollow King', kind:'kill', kill:{boss:1},
    brief:'Orin gave you his staff? <i>Elder Maren\'s brow climbs near to her hairline.</i> That old hoarder has not let a living soul so much as lay a finger on that staff in forty years - and he presses it into the hand of a castaway he has known a week? …Then he sees something in you the rest of us are only starting to. Orin is a great many things, but never a fool. So be it. Then it\'s true - the Hollow King stirs beneath the crypt. Long ago he traded his heart for a crown, and the island has carried his silence since. You\'ll have seen the ward-wall out on the ruined causeway - the sea on either side, a warded gate at its heart. My folk raised it a lifetime ago to seal him in, and I am the last who still knows the word. Say you\'ll face him and I\'ll speak the gate open - for you, and you alone. Take your tonics, your steel, and Orin\'s fire. Emberwick believes in you.',
