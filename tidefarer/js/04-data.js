...
const QUESTS = {
  ...
  kit:{ giver:'bram', title:'Tools of the Trade', kind:'talk', talkTo:'bram',
    brief:'New boots on old sand - welcome, castaway. You\'ll get nowhere on this isle bare-handed. Here: a woodsman\'s axe, a miner\'s pick, and - hold still - a proper iron sword off my own anvil. Chop timber, mine stone, and swing at anything that bites back. Then go see Elder Maren by the well; she\'s been waiting for someone like you.',
    log:'Speak with Bram at the forge to receive your axe, pick, and iron sword.',
    doneText:'Axe for timber, pick for stone, and steel for everything else. *CLANG* - there she is, balanced and mean. Off you go - Maren\'s by the well, and she\'ll have work worthy of that blade.',
    rw:{kit:true, sword:1, gold:5, xp:{woodcut:40, mining:40, melee:60}}, unlocks:['king'] },
