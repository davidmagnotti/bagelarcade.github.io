...
const QUESTS = {
  ...
  mushrooms:{ giver:'orin', title:'Light in the Dark', kind:'gather', need:{mushroom:6},
    brief:'Hm. You have the look of someone who hasn\'t set anything on fire yet. Promising. Fetch me six bluecap mushrooms from the Whisperwood - they only glow where the shade is honest - and I will wake the staff that\'s been asleep in my cellar.',
    log:'Gather 6 bluecaps from the Whisperwood for Orin.',
    doneText:'Bluecaps, crushed… essence, bound… there. This staff will throw fire that answers to you. Press 3. Mind the eyebrows. And here - the ward on my tower is lifted for you now; go inside and lay both hands on the scrying orb, for fire is only half of what a mage owes their feet. One more thing - take Chestnut, the cob grazing by my tower. A mage keeps no use for a horse, and you\'ve a long road ahead. He\'s yours. Whistle and he comes.',
    rw:{staff:true, horse:true, xp:{magic:150}} },
