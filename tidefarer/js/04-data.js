...
const QUESTS = {
  ...
  mushrooms:{ giver:'orin', title:'Light in the Dark', kind:'gather', need:{mushroom:3},
    ...
    doneText:'Bluecaps, crushed… essence, bound… there. This staff will throw fire that answers to you. Press 3. Mind the eyebrows. And here - the ward on my tower is lifted for you now; go inside and lay both hands on the scrying orb, for fire is only half of what a mage owes their feet.',
