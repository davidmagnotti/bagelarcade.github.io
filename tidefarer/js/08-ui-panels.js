...
function refreshInvPanel(){
  ...
  if(INV_SEL){
    ...
    if(canUse)  act+='<button class="btn gold" id="invUseBtn" style="padding:8px 14px;" onclick="useItem(INV_SEL);refreshInvPanel();">'+(it.use==='heal'?'Eat / Drink (+'+it.heal+' HP)':it.use==='arrows'?'Refill quiver (+'+it.arrows+')':'Use')+'</button>';
