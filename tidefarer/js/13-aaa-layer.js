...
function ambientFX(dt){
  ...
  const _sb=(typeof storybookOn==='function') && storybookOn();
  // ruin miasma is grim dressing - hold it back in the storybook (Act I) look
  if(!_sb && ruinD<12 && Math.random()<0.5) spawnFog(P.x+rnd(-9,9),P.y+rnd(-9,9),'rgba(96,116,98,');
  ...
  if(!_sb && ruinD<10 && Math.random()<0.6){
