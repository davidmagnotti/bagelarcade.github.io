...
const MC_RIME = [
  ...
  { who:'The Rimebound, Unbound',
    html:'<b style="color:#8fd8ff">"…cold. So long in the cold."</b> <i>The violet drains out of the great ice-thing — a whale of the deep, once, that swam too near the killing frost and never found the warm dark again.</i>',
    ens:0, calm:0.9 },
  { who:'',
...
const MC_VATH = [
  ...
  { who:'Vath', html:'<b style="color:#c9a0ff">“No stone holds forever, first mate. Your line has caged me before — a lifetime ago, and lifetimes before that. Every seal your kind ever set, I have outwaited. I will thaw. I will come back.”</b>',
