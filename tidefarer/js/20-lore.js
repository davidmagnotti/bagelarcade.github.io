...
const LORE={
  ...
  // ---- Emberwick, the isle every journey begins on: the founding cast's own hands ----
  'elder@isle':{title:"Maren's Village Book", text:'“Elder Maren keeps no ledger of coin - only of people. Every soul the strait washed ashore, and every one it took, set down in a slow and careful hand. <i>We do not ask a castaway their name before we ask if they have eaten.</i> The last line carries no name yet, only this week\'s date and a note: <i>came off the tide with the curse already broken. Bram says promising. Orin says mind that pendant. I say - feed them first, and see what the isle makes of them.</i>”'},
  'forge@isle':{title:"Bram's Work-Book", text:'“Bram\'s book is all iron and no poetry: billets drawn, blades balanced, the colour of each fire noted to the breath. <i>Green one came in this morning - gave them tools, sent them for wood and stone. Good hands. Can see the work in them already.</i> And pressed hard into the page below, in a smith\'s blunt certainty: <i>strait\'s shut, so no new steel comes in - which means I make every blade to LAST. When the sea opens again, let them say the smith on the little isle knew his trade.</i>”'},
  ...
  'castaway@reach':{title:'The Cast-Wall Marks', text:'“Cast sea-stone and shell-mortar, poured squat and low and battered thick - the storm-houses of people the strait stranded, who learned fast that no lean-to lasts a season here. Scratched into the wet of the broadest wall, added to in a dozen different hands: <i>WE WERE NOT WRECKED HERE. We washed up and we STAYED, and we built to LAST, because the Brute walks the barrow road and the reef eats every boat and there was nowhere left to sail TO. Put the beast back in its barrow and maybe this is a port again. Maybe some of us go home.</i>”'},
